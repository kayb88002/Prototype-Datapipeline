...
def summary():
    ...
    sql= "INSERT INTO Corpus(Topic_Search,Summary,Latest News,Hashtags,Sentimental Score,Links, Knowledge Graph) VALUES(%s,%s,%s,%s,%s,%s)"
    val= (query,my_summary,news,hashtags,sentiments,beautifiedLinks)
    myDB.execute(sql,val)
    mysqlDB.commit()
